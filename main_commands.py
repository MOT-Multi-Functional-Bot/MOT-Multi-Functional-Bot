...
def start(update: Update, context: CallbackContext) -> None:
    ...
    msg += f"- /tic if you want to play TicTacToe.\n"
...
def help(update: Update, context: CallbackContext) -> None:
    ...
    msg += "Just kidding! This Bot provides you with four games and some other entertainment features:\n\n"
    ...
    msg += "When playing the /movieguessinggame, the bot will provide you a set of emojis and you have to guess the respective movie title. There are two playmodes you can play in easy and hard.\n\n"
    msg += "When playing the /tic (TicTacToe) game, you can place your piece on the field and try to place three in a row. \n\n"
